...
/*
  ...
  Step 1 - create a ref (in constructor, create a property this.inputRef and assign a value (method) React.createRef())
  Step 2 - Attach this ref to the input element in the render method (to attach a ref, we make use of the reserve ref attribute)
...
class RefDemo1 extends Component {
    ...
    clickHandler = () => {
        // Here we are accessing the value of the input DOM node from the current property
