...
/*
    ...
    But we are unable to access the prop here, because the prop from App.js gets passed to the HOC (WithCounter.js) and it is accessible in the HOC but it is not passed to the component that it wraps.

    To fix this issue, we need to pass the props from the Wrapped component using the spread operator.
...
const withCounter = (WrappedComponent, incrementNumber) => {
    ...
    class WithCounter extends React.Component {
        ...
        render() {
            ...
            // return <WrappedComponent name="Saurabh" count={this.state.count} incrementCount={this.incrementCount}/>
            return (
                <WrappedComponent
