...
/*
  ...
  However, it does not render anything on its own, it is simply going to render whatever is passed as the render prop
  and while doing so, it passes the count and incrementCount method
