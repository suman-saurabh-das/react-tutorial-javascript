...
class Counter extends Component {
    ...
    increment() {
        ...
        */
        ...
        i.e. why the value of count logged in console is one less than the value displayed in UI.
        ...
        */
        ...
        // },
        // () => {
        //     console.log("Callback value : "+this.state.count);  // callback function which logs the updated state value
        // })
        // console.log(this.state.count);

        /*
            React may group multiple setState calls into a single update call for better performance.
            So all 5 setState calls are done in one single go and updated value does not carry over the different calls
