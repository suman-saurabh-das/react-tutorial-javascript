...
/*
    ...
    Reason why binding is needed when using this keyword ->
        When we use this keyword inside a function which was created using function keyword
            ...
            then it creates its own context for the this keyword and it does not have the context for the outer function
            i.e. here we will only be able to access the properties present inside the function using this keyword
        To avoid this and to make sure that we are able to access the properties of outer function, we need binding.
        To avoid this we can also use arrow functions instead of functions created using the function keyword, this is because when we use an arrow function, it does not create its own context and the this here refers to its parents context.
    ...
    Methods of event binding with this keyword
        ...
        2. Using arrow function in the render method - Calling the event handler in arrow function body
        ...
        3. Binding event handler in costructor instead of render method
...
class EventBind extends Component {
    ...
    */
    ...
    // Basically we are changing the way to define the method in class
